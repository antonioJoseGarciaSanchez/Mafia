 ...
 *
 */
public class Jefes extends JFrame{
	...
	private void inizialite() {
        ...
        cadena = new JLabel("Listado de Jefes");
		...
		modelo2 = new DefaultTableModel(null,new String [] {"Nombre","Antiguedad","Subordinados","Encarcelado"});
